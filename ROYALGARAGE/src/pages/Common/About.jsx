    ...
    <>
      <section className="w-full container-main">
          ...
          <div className="flex min-h-3/4 ">
            ...
            <div className="flex-1">
              <p>
                ...
                seller of car parts in the 90s with our director mr kimani at
                the time the shop had only one mechnaic who used to do mere car
                fixes. <br />
                later in the 2000s mr kimani and some four other coluges came
                about and now build the royal autogarage shop which was able to
                do services to about 10 vehicles a week and the progresss
                contuied until now where our garage proces over 100 vehicles in
                a week
              </p>
            </div>
          </div>
        ...
        <div className="h-screen section">
          ...
          <p>
            To empower auto service businesses with smart technology that
            improves productivity, organization, and customer satisfaction.
          </p>
        </div>
        <div>
          <h1> our team </h1>
